        ...
        <div class="card-body">
        	<table class="table table-bordered table-hover table-striped">
        		...
        		<tr>
        			...
        			<td align="right">Rp. <?php echo number_format($total + $total*0.06, 0,',','.') ?></td>
        		</tr>
        		
        	</table>
        
        	<a href="<?php echo base_url('dashboard/riwayat_belanja') ?>"><div class="btn btn-sm btn-primary">Kembali</div></a>
        	<a class="btn btn-warning" target="_blank" href=" <?php echo base_url('dashboard/cetak_invoice/'.$invoice->id) ?>"> <i class="fa fa-file"></i> Export PDF</a>
        </div>
    </div>	
</div>